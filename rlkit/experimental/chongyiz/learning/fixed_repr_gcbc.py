...
from rlkit.torch.sac.fixed_repr_gcbc_trainer import FixedRepresentationGCBCTrainer
...
def fixed_repr_gcbc_experiment(  # NOQA
        max_path_length,
        # qf_kwargs,
        # vf_kwargs,
        # obs_encoder_kwargs,
    ...
    assert policy_class == GoalConditionedGaussianFixedReprPolicy
    ...
    if trainer_type == 'iql':
        ...
        trainer = FixedRepresentationGCBCTrainer(
            env=eval_env,
            policy=policy,
