...
#     z1 = {'N': 30, 'block': DenseNormal}
#     enc += [enc_z1]
#     z += [z1]

#     enc_z2 = [[filters, 3, 1]] * no_layers
#     z2 = {'N': 25, 'block': DenseNormal}
#     enc += [enc_z2]
#     z += [z2]

#     enc_z3 = [[filters, 3, 1]] * no_layers
#     z3 = {'N': 20, 'block': DenseNormal}
#     enc += [enc_z3]
#     z += [z3]

#     enc_z4 = [[filters, 3, 1]] * no_layers
#     z4 = {'N': 15, 'block': DenseNormal}
#     enc += [enc_z4]
#     z += [z4]

#     enc_z5 = [[filters, 3, 1]] * no_layers
#     z5 = {'N': 10, 'block': DenseNormal}
#     enc += [enc_z5]
#     z += [z5]

#     enc_z6 = [[filters, 3, 1]] * no_layers
#     z6 = {'N': 5, 'block': DenseNormal}
#     enc += [enc_z6]
#     z += [z6]

#     return enc, z

def get_conditional_deep_vae():
    """
    Get the binary images Deep VAE configuration.
    :return: enc, z
    """
    ...
    enc_z1 = [[filters, 4, 1]] * no_layers
    z1 = {'N': 20, 'block': DenseNormal}
    enc += [enc_z1]
    z += [z1]

    enc_z2 = [[filters, 3, 1]] * no_layers
    z2 = {'N': 15, 'block': DenseNormal}
    enc += [enc_z2]
    z += [z2]

    enc_z3 = [[filters, 3, 1]] * no_layers
    z3 = {'N': 10, 'block': DenseNormal}
    enc += [enc_z3]
    z += [z3]

    # enc_z4 = [[filters, 3, 1]] * no_layers
    # z4 = {'N': 5, 'block': DenseNormal}
    # enc += [enc_z4]
    # z += [z4]
