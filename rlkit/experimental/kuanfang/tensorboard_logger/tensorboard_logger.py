...
try:
    ...
    from rlkit.experimental.kuanfang.tensorboard_logger.tf_protobuf import summary_pb2, event_pb2
from rlkit.experimental.kuanfang.tensorboard_logger.crc32c import crc32c
