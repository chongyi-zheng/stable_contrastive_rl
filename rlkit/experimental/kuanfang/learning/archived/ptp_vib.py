...
from rlkit.torch.sac.iql_vib_trainer_v0 import IQLVIBTrainerV0
from rlkit.torch.sac.iql_vib_trainer_v1 import IQLVIBTrainerV1
from rlkit.torch.sac.iql_vib_trainer_v2 import IQLVIBTrainerV2
...
from rlkit.experimental.kuanfang.networks.encoding_networks import EncodingGaussianPolicyV3  # NOQA
...
def ptp_experiment(  # NOQA
    ...
    def concat_context_to_obs(batch,
        ...
        context = new_contexts[desired_goal_key]
    ...
    if use_pretrained_rl_path:
        ...
        def create_qf():
            ...
            if qf_class in [ConcatCNN, ConcatTwoChannelCNN]:
        ...
        if use_encoder_in_policy:
            if policy_class == EncodingGaussianPolicyV3:
                policy_kwargs['obs_encoder'] = model['vqvae']
            else:
    ...
    # print('path_collector_observation_keys: ')
    # print(path_collector_observation_keys)
    # input()
    ...
    def obs_processor(o):
        ...
        # print(path_collector_observation_keys)
        # print(path_collector_context_keys_for_policy)
        # input()
        #
    ...
    if trainer_type == 'iql':
        ...
        assert use_encoder_in_policy
        trainer = IQLVIBTrainerV1(
            env=eval_env,
            policy=policy,
            qf1=qf1,
            qf2=qf2,
